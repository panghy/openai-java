...
public class OpenAiService {
  ...
  public Flowable<SseEventCallback.Event> streamCreateRun(String threadId, RunCreateRequest runCreateRequest) {
    runCreateRequest.setStream(true);
    SseEventCallback eventCallback = new SseEventCallback();
    return stream(api.createRunStream(threadId, runCreateRequest)).
  ...
  public Flowable<SseEventCallback.Event> streamCreateThreadAndRun(CreateThreadAndRunRequest createThreadAndRunRequest) {
    createThreadAndRunRequest.setStream(true);
    SseEventCallback eventCallback = new SseEventCallback();
    return stream(api.createThreadAndRunStream(createThreadAndRunRequest)).
        map(eventCallback::apply);
  }
